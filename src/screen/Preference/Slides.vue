    ...
    <div className="fields">
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_initialNumber">
      ...
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_animationType">
      ...
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_animationSpeed">
      ...
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_captionAnimationType">
      ...
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_captionAnimationSpeed">
      ...
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_autoplayDelay">
      ...
      <div className="field-basic">
        <h3 className="field-title">
          <label htmlFor="pref_autoplayDirection">
      ...
      <div className="field-switch">
        <div className="field-switch__body">
          <h3 className="field-title">
            <label htmlFor="pref_autoplayPauseOnHover">
